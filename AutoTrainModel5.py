...
data_path = "/home/oem/Desktop/HogDataset/data.yaml"
imgsz = 640
...
for i, params in enumerate(param_combinations, start=1):
    ...
    # If the results folder already exists, skip this experiment
    if os.path.exists(model_results_path):
        print(f"\n===== Experiment {i}/{len(param_combinations)}: {model_name} already exists. Skipping. =====")
        continue
    ...
    try:
        ...
        print(f"===== Completed training for {model_name}. Results are in: {model_results_path} =====")
